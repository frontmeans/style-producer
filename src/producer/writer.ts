...
export namespace StypWriter {
  ...
  export interface Sheet {
     ...
     * @param index - A positive integer less than or equal to the number of added rules, representing the newly
     * inserted rule's position in target style sheet. The default is the number of added rules.
     */
  ...
  export interface Group {
     ...
     * @param params - Verbatim parameters of newly inserted rule. E.g. media query.
     * @param index - A positive integer less than or equal to the number of added rules, representing the newly
     * inserted rule's position in target grouping rule. The default is the number of added rules.
     *
     * @returns  Inserted CSS style declarations writer.
     */
    addGroup(name: string, params?: string, index?: number): Group;
  ...
  export interface Style {
     ...
     * @param priority - New property value priority. The value {@link StypPriority.Important} and above means the
